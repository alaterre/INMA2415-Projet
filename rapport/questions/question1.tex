...
\begin{figure}[H]
    ...
    \input{images/biomass_generator.tikz}
...
\begin{figure}[H]
    ...
    \setlength\fheight{4cm}
    \setlength\fwidth{0.8\textwidth}
    \input{images/nuclear_generator.tikz}
...
\begin{figure}[H]
    ...
    \input{images/gas_generator.tikz}
...
\begin{figure}[H]
    ...
    \setlength\fheight{4cm}
    \setlength\fwidth{0.8\textwidth}
    \input{images/oil_generator.tikz}
...
\begin{figure}[H]
    ...
    \setlength\fheight{4cm}
    \setlength\fwidth{0.8\textwidth}
    \input{images/marg_generator.tikz}
